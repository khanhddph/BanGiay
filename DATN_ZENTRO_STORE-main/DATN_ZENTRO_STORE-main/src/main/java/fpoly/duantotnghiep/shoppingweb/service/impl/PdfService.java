...
public class PdfService {
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        Paragraph title3 = new Paragraph("So dien thoai: 0369015055"+
                "\nEmail: zentrostoresneaker@gmail.com" +
                "\nDia chi: Nha so 3,Ngo 5,Vo Quy Huan,Phuc Dien,Bac Tu Liem, Ha Noi\n------------------------------------------",
